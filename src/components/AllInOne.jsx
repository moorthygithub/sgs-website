    ...
    <div className="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700">
      <div data-aos="flip-up" className="max-w-xl mx-auto text-center mt-24">
        ...
        <p className="leading-relaxed text-gray-500">
          Our community platform brings together everything you need —
          connection, support, and opportunities to grow together.
        </p>
      </div>
      {/* card */}
      <div className="grid md:grid-cols-3 gap-14 md:gap-5 mt-20">
        ...
        >
          ...
          <p className="px-4 text-gray-500">
            Connect with fellow members, share experiences, and build lasting
        ...
        >
          ...
          <p className="px-4 text-gray-500">
            Access guidance, mentorship, and resources that help members
        ...
        >
          ...
          <p className="px-4 text-gray-500">
            Stay updated with community gatherings, cultural programs, and
            special initiatives that bring people together.
          </p>
        </div>
      </div>
    </div>
