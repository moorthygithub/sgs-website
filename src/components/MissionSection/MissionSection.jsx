              ...
              <AnimateOnScroll type="zoom-in" delay={0.25}>
                <div className="pt-4">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="inline-flex cursor-pointer items-center gap-2 !bg-orange-500 !text-white px-8 py-4 rounded-2xl font-semibold hover:bg-orange-600 transition-all shadow-lg group"
                  >
                    Learn More
