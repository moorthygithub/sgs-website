          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed text-justify">
                ...
                formed with the vision of uniting Gujaratis under one platform.
                Our mission is to promote cultural heritage, strengthen
                community relationships, and support members in social,
                educational, and charitable initiatives.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed text-justify">
                With regular gatherings, festivals, and programs, we aim to keep
                the spirit of Gujarat alive wherever we are. Join us in
                preserving traditions while creating new bonds of friendship and
                growth.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button className="group px-8 py-4 bg-gradient-to-r from-orange-600 to-red-600 text-white font-semibold rounded-xl hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center gap-2">
                Explore More
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="px-8 py-4 bg-white text-orange-600 font-semibold rounded-xl hover:shadow-lg transition-all duration-300 border-2 border-orange-600 hover:bg-orange-50">
                Join Community
              </button>
            </div>
          </div>
