function Hero() {
  return (
    <div className="bg-red-200">
      <div className="max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start pt-12">
        <div className="flex flex-col w-full lg:w-6/12 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
          ...
          >
            <span className="text-red-500">Building</span> Stronger
          ...
          >
            Our community is a place where people come together to share, learn,
